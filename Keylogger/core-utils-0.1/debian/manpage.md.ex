% core-utils(SECTION) | User Commands
%
% "November 24 2021"
...
core-utils - program to do something

# SYNOPSIS

**core-utils** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**core-utils** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **core-utils** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**core-utils** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    core-utils. See **foo.conf**(5) for further details.
...
**core-utils** provides some return codes, that can be used in scripts:
...
bhavyagoel <bhavyagoel@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 bhavyagoel
